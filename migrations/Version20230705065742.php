 ...
 */
final class Version20230705065742 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE used_car DROP image_name');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE used_car ADD image_name VARCHAR(255) DEFAULT NULL');
    }
}
